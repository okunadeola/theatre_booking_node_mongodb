...
//*** user page header dropdown. you could use NextUI or antd dropdown component instead ***//
const DropdownUser = ({user}) => {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const { removeCurrentUser } = useCurrentUser(); // from zustand state manager for the app
