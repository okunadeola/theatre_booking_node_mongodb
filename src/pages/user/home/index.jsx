...
const onDateChange = (dates)=>{
  ...
  return (
    <div className="bg-[#0e1012]">
      <HeroSlide />
      <div className="section container relative  sm:-top-60">
          ...
          <div className="flex  gap-2  md:gap-10 flex-wrap mb-5">
            <div className="flex flex-col">
                ...
                <div className="flex gap-3 py-4 mb-4">
                  ...
                  <div className="flex items-center justify-center px-4 py-2 bg-[#272727] rounded-sm cursor-pointer hover:opacity-90">
                    <span className="text-white/80 font-medium">LOVE</span>
                  </div>
                  <div className="flex items-center justify-center px-4 py-2 bg-[#272727] rounded-sm cursor-pointer hover:opacity-90">
                    <span className="text-white/80 font-medium">AI</span>
                  </div>
                  <div className="flex items-center justify-center px-4 py-2 bg-[#272727] rounded-sm cursor-pointer hover:opacity-90">
                    <span className="text-white/80 font-medium">SPORT</span>
                  </div>
                </div>
            </div> 
