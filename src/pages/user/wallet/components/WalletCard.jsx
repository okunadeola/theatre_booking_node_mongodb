  ...
  return (
    <div className="rounded-lg bg-white p-4 text-sm shadow-card dark:bg-light-dark sm:p-5 md:p-6">
      <div className="flex items-center justify-between border-b border-dashed border-gray-200 pb-3.5 dark:border-gray-700 sm:pb-5">
        ...
        <div className="truncate text-xs -tracking-wide text-gray-600 ltr:pl-2 rtl:pr-2 dark:text-gray-400 xs:text-sm flex gap-1 ">
          <span>{date}</span>
        ...
        <div className="col-span-4  flex flex-col gap-2.5 sm:flex-row sm:gap-x-4 md:flex-col 2xl:flex-row w-full">
          <div className="flex items-center gap-1">
            ...
            <div className="flex flex-col truncate ltr:ml-2.5 rtl:mr-2.5 xl:ltr:ml-4 xl:rtl:mr-4">
              ...
              <strong className="truncate font-medium -tracking-wider flex gap-1 text-gray-900 dark:text-white">
                <span>{gasFee + 40}</span>
          ...
          <div className="flex items-center gap-1 ">
            ...
            <div className="flex flex-col truncate ltr:ml-2.5 rtl:mr-2.5 xl:ltr:ml-4 xl:rtl:mr-4">
              ...
              <strong className="font-medium -tracking-wider text-gray-900 dark:text-white flex gap-1">
                <span>{gasFee}</span>
                <span>{currencyType}</span>
              </strong>
            </div>
