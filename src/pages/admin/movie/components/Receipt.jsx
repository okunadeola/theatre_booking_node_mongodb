...
const Receipt = ({isOpen, onClose, data}) => {
  ...
  return (
    <>
      ...
      <Drawer placement="right" size={'large'} onClose={()=>{}} open={isOpen}  maskClosable={false} style={{backgroundImage: "linear-gradient(to bottom,rgba(0,0,0,0.2), rgba(1,1,2,0.8), rgba(1,1,2,0.8), rgba(1,1,2,0.8),rgba(0,0,0,0.2)"}} className="bg-gray-500 overflow-hidden font-Poppins   bg-[linear-gradient(to_bottom,rgba(1,1,2,0.8),rgba(0,0,0,0.2))] "  >
       ...
       <div className="flex flex-col  px-2  gap-2">
        ...
        {/* <div  className="flex w-full justify-center" > */}
            <TinderCard key={2} onSwipe={onSwipe} onCardLeftScreen={() => onCardLeftScreen('fooBar')} preventSwipe={['right', 'left']}>
